...
class TestLifecycleE2E:
    ...
    async def test_full_idle_pause_resume_cycle(self) -> None:
        ...
        with (
            ...
            async def mock_send_message(conv_id: str, prompt: str, harness: str = "claude-code", **kwargs: Any):
                turn_count[0] += 1
    ...
    async def test_idle_timer_cancelled_during_turn(self) -> None:
        ...
        with (
            ...
            async def slow_send_message(conv_id: str, prompt: str, harness: str = "claude-code", **kwargs: Any):
