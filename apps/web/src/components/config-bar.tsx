...
export function ConfigBar({ disabled, onSubmit }: ConfigBarProps) {
    ...
    <div className="rounded-lg border border-border bg-card p-4 space-y-4">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <Label className="text-xs text-muted-foreground">Secrets / Env Vars</Label>
          <Button
            variant="ghost"
            size="sm"
            onClick={addSecret}
      ...
      <Button size="sm" onClick={handleApply} disabled={disabled} className="w-full">
        Apply Configuration
      </Button>
    </div>
  );
